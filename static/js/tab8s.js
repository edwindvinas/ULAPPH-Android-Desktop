...
ULAPPH_SEARCH.Util = {
  sslAssetHost: "http://glowing-run-98319.appspot.com",
  assetHost: "",
...
ULAPPH_SEARCH.PopIn = {
  show: function() {
	...
	var idx = "AUTO";	
	var slink = "/search?q=" + "" + "&f=glow2&IDX=" + idx + "&SID=" + SID + "&t=InDoc";
    ULAPPH_SEARCH.Dialog.show("<iframe src=\"" + slink + "\" frameborder=\"0\" scrolling=\"yes\" allowtransparency=\"true\" width=\"700px\" height=\"530px\"></iframe>");
  }
}
