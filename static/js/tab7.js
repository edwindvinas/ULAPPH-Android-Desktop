...
// Load CSS and images
ULAPPH_SEARCH.Util.includeCss(ULAPPH_SEARCH.Util.render(ULAPPH_SEARCH.Dialog.css_template, {background_image_url: 'http://lh3.googleusercontent.com/ptpIm_0V-Ey3HYRz6rmgtV4HvWiz7WNDWmxy1p7kpRRGVe7lBd2b-wxNI53SG4TZzX5gRWXYzhdUoBSUuXpZJwKXmsq5'}));
//added by ULAPPH
ULAPPH_SEARCH.PopIn = {
  show: function() {
    var referer = window.location.href;
    if (referer.indexOf('?') != -1) { referer = referer.substring(0, referer.indexOf('?')) } // strip params
	var url = "/search?f=glow";
    ULAPPH_SEARCH.Dialog.show("<iframe src=\"" + url + "\" frameborder=\"0\" scrolling=\"yes\" allowtransparency=\"true\" width=\"900px\" height=\"530px\"></iframe>");
  }
}
