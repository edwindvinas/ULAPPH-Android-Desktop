...
(function ($) {
  ...
  AblePlayer.prototype.setButtonImages = function() { 
    ...
    var imgPath = '/static/img/ump/' + this.iconColor + '/';
          ...
          if (tracks.length) {       
            ...
            if (typeof this.$ccButton === 'undefined') { 
              ...
              if (this.iconType === 'font') {
                ...
                // use images
                buttonImg = $('<img>',{ 
                  'src': '/static/img/ump/' + this.iconColor + '/captions.png',
                  'alt': '',
                  'role': 'presentation'
                });
      ...
      for (j=0; j<controls.length; j++) { 
        ...
        if (control === 'seek') { 
          ...
          if (this.iconType === 'font') {
            ...
            var pipeImg = $('<img>', {
              src: '/static/img/ump/' + this.iconColor + '/pipe.png',
              alt: '',
              role: 'presentation'
            });
            pipe.append(pipeImg);
          ...
          if (control === 'mute') { 
            buttonImgSrc = '/static/img/ump/' + this.iconColor + '/volume-mute.png';
          }
          else if (control === 'fullscreen') { 
            buttonImgSrc = '/static/img/ump/' + this.iconColor + '/fullscreen-expand.png';            
          }
          else { 
            buttonImgSrc = '/static/img/ump/' + this.iconColor + '/' + control + '.png';
          }
...
(function ($) {
  ...
  AblePlayer.prototype.addWindowMenu = function() { 
    ...
    if (this.iconType === 'font') {
      ...
      // use image
      var buttonImgSrc = '/static/img/ump/' + this.iconColor + '/preferences.png';
      var $buttonImg = $('<img>',{ 
        'src': buttonImgSrc,
        'alt': '',
        'role': 'presentation'
