...
ULAPPH_PEOPLE.Dialog = {
  ...
  show: function(id_or_html) {
    ...
    this.Overlay.show();
    this.setPosition();
    ULAPPH_PEOPLE.Element.addClassName(this.htmlElement(), 'dialog-open');
  ...
  close: function() {
		var change = ULAPPH_PEOPLE.needsConfirm;
		if(change){
    ...
    ULAPPH_PEOPLE.Element.removeClassName(this.htmlElement(), 'dialog-open');
    this.Overlay.hide();
    ULAPPH_PEOPLE.onClose();
  },
  ...
  (ULAPPH_PEOPLE.Util.isIE() && (ULAPPH_PEOPLE.Util.isIE(function(v){return v < 7}) || (ULAPPH_PEOPLE.Util.isIE(function(v){return v >= 7}) && ULAPPH_PEOPLE.Util.isQuirksMode()))) ? "\
    #ulapph-overlay,\
    #ulapph-dialog {\
      position: absolute;\
    }\
  ...
  element: function() {
    if (!document.getElementById(this.id)){
      ...
      dummy.innerHTML = '<div id="'+this.id+'" class="ulapph-component" style="display:none;">' +
        '<a href="#close" onclick="ULAPPH_PEOPLE.Dialog.close(); return false;" id="'+this.id+'-close" title="Close Dialog"><span style="display: none;">Close Dialog</span></a>' +
  ...
  setPosition: function() {
    var dialogDimensions = ULAPPH_PEOPLE.Element.getDimensions(this.element());
    var pageDimensions = ULAPPH_PEOPLE.Page.getDimensions();
...
ULAPPH_PEOPLE.Dialog.Overlay = {
  ...
  element: function() {
    if (!document.getElementById(this.id)) {
      var dummy = document.createElement('div');
      dummy.innerHTML = '<div id="'+this.id+'" class="ulapph-component" onclick="ULAPPH_PEOPLE.Dialog.close(); return false;" style="display:none;"></div>';
      /* this is the safe way to do insertion in IE when the page has yet to be loaded */
      document.body.insertBefore(dummy.firstChild, document.body.firstChild);
    }
    return document.getElementById(this.id);
...
ULAPPH_PEOPLE.needsConfirm = false;
ULAPPH_PEOPLE.onClose = function() {};

// Load CSS and images
ULAPPH_PEOPLE.Util.includeCss(ULAPPH_PEOPLE.Util.render(ULAPPH_PEOPLE.Dialog.css_template, {background_image_url: 'http://lh4.ggpht.com/v5vgvBUHeXAzLcx-xLhVWRAo6IScq0eSPkQhGQtIu6tsvTc-ULjE0NS4E6oKXosntn5mjr9ZBaQFuBcBuUyDI7KVdFrvzmIlJA'}));

ULAPPH_PEOPLE.PopIn = {
  show: function() {
    var referer = window.location.href;
    if (referer.indexOf('?') != -1) { referer = referer.substring(0, referer.indexOf('?')) } // strip params
	var url = "/people?PEOPLE_FUNC=QUICK-VIEW";
    ULAPPH_PEOPLE.Dialog.show("<iframe src=\"" + url + "\" frameborder=\"0\" scrolling=\"yes\" allowtransparency=\"true\" width=\"700px\" height=\"530px\"></iframe>");
  }
}

document.write("\n  \u003Cstyle type=\"text/css\"\u003E\n    a#ulapph-people-tab {\n      position: fixed;\n      left: 0;\n      top: 30%;\n      display: block;\n      background: #00BCBA url(http://lh3.googleusercontent.com/m0_HslEYS6j-tOXHu1AZUimz6UqHYiTGMrn4aBfw9rUSJGwO7hg_9f79_pVM80WsqWzS56QIeYpbpkWgUQLJrRNUi_Q) -2px 50% no-repeat;\n      width: 25px;\n      height: 90px;\n      margin-top: -45px;\n      border: outset 1px #00BCBA;\n      border-right: none;\n      z-index: 100001;\n    }\n\n    a#ulapph-people-tab:hover {\n      background-color: #06c;\n      border: outset 1px #06c;\n      border-right: none;\n      cursor: pointer;\n    }\n  \u003C/style\u003E\n\n  \u003C!--[if IE]\u003E\n    \u003Cstyle type=\"text/css\"\u003E\n      * html a#ulapph-people-tab {\n        position: absolute;\n        background-image: none;\n        filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://lh3.googleusercontent.com/m0_HslEYS6j-tOXHu1AZUimz6UqHYiTGMrn4aBfw9rUSJGwO7hg_9f79_pVM80WsqWzS56QIeYpbpkWgUQLJrRNUi_Q');\n      }\n    \u003C/style\u003E\n  \u003C![endif]--\u003E\n\n  \u003Ca id=\"ulapph-people-tab\" onclick=\"ULAPPH_PEOPLE.PopIn.show(); return false;\" href=\"/people?PEOPLE_FUNC=QUICK-VIEW\"\u003E\u003C/a\u003E\n\n")
