...
// var ValPassword = $('#password').val() === 'bsi888'; 
  var passwordRandom = document.getElementById("passwordRandom").value;

  //var ValPassword = $('#password').val() === $('#password').val();  
  var ValPassword = $('#password').val() === passwordRandom;   
    if (ValPassword === true) {
