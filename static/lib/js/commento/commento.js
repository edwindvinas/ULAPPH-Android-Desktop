(function(global, document) {
    ...
    var _makeCards = function(parentMap, cur) {
        ...
        currentParent.forEach(function(comment) {
            ...
            h5.innerHTML = comment.name + ' ' + '<a href=\"/social?SO_FUNC=ViewPeople&UID=' + comment.uid + '\" title=\"View Profile\" target=\"prof\"><img src=\"' + comment.profile + '\" width=30 height=30></a>' + '<a href=\"https://www.google.com/maps/place/' + comment.latlon + '\" title=\"Show Map\" target=\"loc\">' + '<img src=\"/static/img/mapmarker.png\" width=25 height=25></a>' + '<img src=\"' + comment.country + '\" width=30 height=20>';
