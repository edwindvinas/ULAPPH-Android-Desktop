...
mindmaps.OpenDocumentView = function() {
  ...
  //ulapph
  var $loadCloudButton = $("#button-cloud-loader").button().click(function() {
    if (self.loadCloudButtonClicked) {
      self.loadCloudButtonClicked();
    }
  });
...
mindmaps.OpenDocumentPresenter = function(eventBus, mindmapModel, view, filePicker) {
  ...
  */
  ...
  //ulapph
  /**
  * View callback: Load media from cloud desktop
  * 
  * @ignore
  */
  view.loadCloudButtonClicked = function(e) {
    mindmaps.Util.trackEvent("Clicks", "button-cloud-loader");
      ...
      try {
          ...
          //ulapph
            ...
            if (urlParams["SID"] != "" && urlParams["SID"] != undefined) {
              //alert("Loading data... Please wait... This may take a while.");
              //get from server
                var xmlhttp;
                ...
                var map_url = "";
                map_url = '/media?FUNC_CODE=RAWJSON&SID=' + urlParams["SID"];
                console.log("map_url: "+map_url);
                xmlhttp.open("POST",map_url,true);
                xmlhttp.send();
                 ...
                 xmlhttp.onreadystatechange=function()
                  ...
                  if (xmlhttp.readyState==4 && xmlhttp.status==200)
                  {
                    ...
                    if (xmlhttp.responseText != "") {
                      ...
                      var doc = mindmaps.Document.fromJSON(objJSON);
                      mindmapModel.setDocument(doc);
                      mindmapModel.setDocument(doc);
                      view.hideOpenDialog();
